...
if ("$ENV{VCPKG_ROOT}" STREQUAL "")
    ...
    find_program (FLATBUFFERS_FLATC_EXECUTABLE NAMES flatc PATHS ${VCPKG_TOOLS_DIR}/flatbuffers)
    find_path (FLATBUFFERS_INCLUDE_DIR NAMES flatbuffers/flatbuffers.h PATHS ${VCPKG_INCLUDE_DIR})
endif ()
