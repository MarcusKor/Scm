...
#ifndef FLATBUFFERS_GENERATED_PROTOCOL_VS3CODEFACTORY_CORE_H_
#define FLATBUFFERS_GENERATED_PROTOCOL_VS3CODEFACTORY_CORE_H_
...
struct S2C_DISCONECTED_RES;
struct S2C_DISCONECTED_RESBuilder;
...
enum Packet : uint8_t {
  ...
  Packet_S2C_DISCONECTED_RES = 11,
  Packet_MIN = Packet_NONE,
  Packet_MAX = Packet_S2C_DISCONECTED_RES
};
...
inline const char *EnumNamePacket(Packet e) {
  if (::flatbuffers::IsOutRange(e, Packet_NONE, Packet_S2C_DISCONECTED_RES)) return "";
...
template<> struct PacketTraits<VS3CODEFACTORY::CORE::C2S_CONNECT_REQ> {
  static const Packet enum_value = Packet_C2S_CONNECT_REQ;
};

template<> struct PacketTraits<VS3CODEFACTORY::CORE::S2C_CONNECT_RES> {
  static const Packet enum_value = Packet_S2C_CONNECT_RES;
};

template<> struct PacketTraits<VS3CODEFACTORY::CORE::C2S_ENTER_REQ> {
  static const Packet enum_value = Packet_C2S_ENTER_REQ;
};

template<> struct PacketTraits<VS3CODEFACTORY::CORE::S2C_ENTER_RES> {
  static const Packet enum_value = Packet_S2C_ENTER_RES;
};

template<> struct PacketTraits<VS3CODEFACTORY::CORE::C2S_USERLIST_REQ> {
  static const Packet enum_value = Packet_C2S_USERLIST_REQ;
};

template<> struct PacketTraits<VS3CODEFACTORY::CORE::S2C_USERLIST_RES> {
  static const Packet enum_value = Packet_S2C_USERLIST_RES;
};

template<> struct PacketTraits<VS3CODEFACTORY::CORE::C2S_LEAVE_REQ> {
  static const Packet enum_value = Packet_C2S_LEAVE_REQ;
};

template<> struct PacketTraits<VS3CODEFACTORY::CORE::S2C_LEAVE_RES> {
  static const Packet enum_value = Packet_S2C_LEAVE_RES;
};

template<> struct PacketTraits<VS3CODEFACTORY::CORE::C2S_CHAT_REQ> {
  static const Packet enum_value = Packet_C2S_CHAT_REQ;
};

template<> struct PacketTraits<VS3CODEFACTORY::CORE::S2C_CHAT_RES> {
  static const Packet enum_value = Packet_S2C_CHAT_RES;
};

template<> struct PacketTraits<VS3CODEFACTORY::CORE::S2C_DISCONECTED_RES> {
  static const Packet enum_value = Packet_S2C_DISCONECTED_RES;
};
...
inline ::flatbuffers::Offset<C2S_CONNECT_REQ> CreateC2S_CONNECT_REQDirect(
  ...
  return VS3CODEFACTORY::CORE::CreateC2S_CONNECT_REQ(
      _fbb,
      name__);
}
...
inline ::flatbuffers::Offset<S2C_ENTER_RES> CreateS2C_ENTER_RESDirect(
    ...
    const char *name = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  return VS3CODEFACTORY::CORE::CreateS2C_ENTER_RES(
      _fbb,
      name__);
}
...
inline ::flatbuffers::Offset<S2C_USERLIST_RES> CreateS2C_USERLIST_RESDirect(
  ...
  return VS3CODEFACTORY::CORE::CreateS2C_USERLIST_RES(
      _fbb,
      name__);
}
...
inline ::flatbuffers::Offset<S2C_LEAVE_RES> CreateS2C_LEAVE_RESDirect(
    ...
    const char *name = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  return VS3CODEFACTORY::CORE::CreateS2C_LEAVE_RES(
      _fbb,
      name__);
}
...
inline ::flatbuffers::Offset<C2S_CHAT_REQ> CreateC2S_CHAT_REQDirect(
  ...
  return VS3CODEFACTORY::CORE::CreateC2S_CHAT_REQ(
      _fbb,
      message__);
}
...
inline ::flatbuffers::Offset<S2C_CHAT_RES> CreateS2C_CHAT_RESDirect(
  ...
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto message__ = message ? _fbb.CreateString(message) : 0;
  return VS3CODEFACTORY::CORE::CreateS2C_CHAT_RES(
      _fbb,
      name__,
      message__);
}

struct S2C_DISCONECTED_RES FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef S2C_DISCONECTED_RESBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_NAME = 4
  };
  const ::flatbuffers::String *name() const {
...
struct S2C_DISCONECTED_RESBuilder {
  typedef S2C_DISCONECTED_RES Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(S2C_DISCONECTED_RES::VT_NAME, name);
  }
  explicit S2C_DISCONECTED_RESBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<S2C_DISCONECTED_RES> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<S2C_DISCONECTED_RES>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<S2C_DISCONECTED_RES> CreateS2C_DISCONECTED_RES(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> name = 0) {
  S2C_DISCONECTED_RESBuilder builder_(_fbb);
  builder_.add_name(name);
  return builder_.Finish();
}

inline ::flatbuffers::Offset<S2C_DISCONECTED_RES> CreateS2C_DISCONECTED_RESDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const char *name = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  return VS3CODEFACTORY::CORE::CreateS2C_DISCONECTED_RES(
      _fbb,
      name__);
}
...
struct Root FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  VS3CODEFACTORY::CORE::Packet packet_type() const {
    return static_cast<VS3CODEFACTORY::CORE::Packet>(GetField<uint8_t>(VT_PACKET_TYPE, 0));
  }
  const void *packet() const {
    return GetPointer<const void *>(VT_PACKET);
  }
  template<typename T> const T *packet_as() const;
  const VS3CODEFACTORY::CORE::C2S_CONNECT_REQ *packet_as_C2S_CONNECT_REQ() const {
    return packet_type() == VS3CODEFACTORY::CORE::Packet_C2S_CONNECT_REQ ? static_cast<const VS3CODEFACTORY::CORE::C2S_CONNECT_REQ *>(packet()) : nullptr;
  }
  const VS3CODEFACTORY::CORE::S2C_CONNECT_RES *packet_as_S2C_CONNECT_RES() const {
    return packet_type() == VS3CODEFACTORY::CORE::Packet_S2C_CONNECT_RES ? static_cast<const VS3CODEFACTORY::CORE::S2C_CONNECT_RES *>(packet()) : nullptr;
  }
  const VS3CODEFACTORY::CORE::C2S_ENTER_REQ *packet_as_C2S_ENTER_REQ() const {
    return packet_type() == VS3CODEFACTORY::CORE::Packet_C2S_ENTER_REQ ? static_cast<const VS3CODEFACTORY::CORE::C2S_ENTER_REQ *>(packet()) : nullptr;
  }
  const VS3CODEFACTORY::CORE::S2C_ENTER_RES *packet_as_S2C_ENTER_RES() const {
    return packet_type() == VS3CODEFACTORY::CORE::Packet_S2C_ENTER_RES ? static_cast<const VS3CODEFACTORY::CORE::S2C_ENTER_RES *>(packet()) : nullptr;
  }
  const VS3CODEFACTORY::CORE::C2S_USERLIST_REQ *packet_as_C2S_USERLIST_REQ() const {
    return packet_type() == VS3CODEFACTORY::CORE::Packet_C2S_USERLIST_REQ ? static_cast<const VS3CODEFACTORY::CORE::C2S_USERLIST_REQ *>(packet()) : nullptr;
  }
  const VS3CODEFACTORY::CORE::S2C_USERLIST_RES *packet_as_S2C_USERLIST_RES() const {
    return packet_type() == VS3CODEFACTORY::CORE::Packet_S2C_USERLIST_RES ? static_cast<const VS3CODEFACTORY::CORE::S2C_USERLIST_RES *>(packet()) : nullptr;
  }
  const VS3CODEFACTORY::CORE::C2S_LEAVE_REQ *packet_as_C2S_LEAVE_REQ() const {
    return packet_type() == VS3CODEFACTORY::CORE::Packet_C2S_LEAVE_REQ ? static_cast<const VS3CODEFACTORY::CORE::C2S_LEAVE_REQ *>(packet()) : nullptr;
  }
  const VS3CODEFACTORY::CORE::S2C_LEAVE_RES *packet_as_S2C_LEAVE_RES() const {
    return packet_type() == VS3CODEFACTORY::CORE::Packet_S2C_LEAVE_RES ? static_cast<const VS3CODEFACTORY::CORE::S2C_LEAVE_RES *>(packet()) : nullptr;
  }
  const VS3CODEFACTORY::CORE::C2S_CHAT_REQ *packet_as_C2S_CHAT_REQ() const {
    return packet_type() == VS3CODEFACTORY::CORE::Packet_C2S_CHAT_REQ ? static_cast<const VS3CODEFACTORY::CORE::C2S_CHAT_REQ *>(packet()) : nullptr;
  }
  const VS3CODEFACTORY::CORE::S2C_CHAT_RES *packet_as_S2C_CHAT_RES() const {
    return packet_type() == VS3CODEFACTORY::CORE::Packet_S2C_CHAT_RES ? static_cast<const VS3CODEFACTORY::CORE::S2C_CHAT_RES *>(packet()) : nullptr;
  }
  const VS3CODEFACTORY::CORE::S2C_DISCONECTED_RES *packet_as_S2C_DISCONECTED_RES() const {
    return packet_type() == VS3CODEFACTORY::CORE::Packet_S2C_DISCONECTED_RES ? static_cast<const VS3CODEFACTORY::CORE::S2C_DISCONECTED_RES *>(packet()) : nullptr;
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const VS3CODEFACTORY::CORE::C2S_CONNECT_REQ *Root::packet_as<VS3CODEFACTORY::CORE::C2S_CONNECT_REQ>() const {
  return packet_as_C2S_CONNECT_REQ();
}

template<> inline const VS3CODEFACTORY::CORE::S2C_CONNECT_RES *Root::packet_as<VS3CODEFACTORY::CORE::S2C_CONNECT_RES>() const {
  return packet_as_S2C_CONNECT_RES();
}

template<> inline const VS3CODEFACTORY::CORE::C2S_ENTER_REQ *Root::packet_as<VS3CODEFACTORY::CORE::C2S_ENTER_REQ>() const {
  return packet_as_C2S_ENTER_REQ();
}

template<> inline const VS3CODEFACTORY::CORE::S2C_ENTER_RES *Root::packet_as<VS3CODEFACTORY::CORE::S2C_ENTER_RES>() const {
  return packet_as_S2C_ENTER_RES();
}

template<> inline const VS3CODEFACTORY::CORE::C2S_USERLIST_REQ *Root::packet_as<VS3CODEFACTORY::CORE::C2S_USERLIST_REQ>() const {
  return packet_as_C2S_USERLIST_REQ();
}

template<> inline const VS3CODEFACTORY::CORE::S2C_USERLIST_RES *Root::packet_as<VS3CODEFACTORY::CORE::S2C_USERLIST_RES>() const {
  return packet_as_S2C_USERLIST_RES();
}

template<> inline const VS3CODEFACTORY::CORE::C2S_LEAVE_REQ *Root::packet_as<VS3CODEFACTORY::CORE::C2S_LEAVE_REQ>() const {
  return packet_as_C2S_LEAVE_REQ();
}

template<> inline const VS3CODEFACTORY::CORE::S2C_LEAVE_RES *Root::packet_as<VS3CODEFACTORY::CORE::S2C_LEAVE_RES>() const {
  return packet_as_S2C_LEAVE_RES();
}

template<> inline const VS3CODEFACTORY::CORE::C2S_CHAT_REQ *Root::packet_as<VS3CODEFACTORY::CORE::C2S_CHAT_REQ>() const {
  return packet_as_C2S_CHAT_REQ();
}

template<> inline const VS3CODEFACTORY::CORE::S2C_CHAT_RES *Root::packet_as<VS3CODEFACTORY::CORE::S2C_CHAT_RES>() const {
  return packet_as_S2C_CHAT_RES();
}

template<> inline const VS3CODEFACTORY::CORE::S2C_DISCONECTED_RES *Root::packet_as<VS3CODEFACTORY::CORE::S2C_DISCONECTED_RES>() const {
  return packet_as_S2C_DISCONECTED_RES();
}
...
struct RootBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_packet_type(VS3CODEFACTORY::CORE::Packet packet_type) {
...
inline ::flatbuffers::Offset<Root> CreateRoot(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    VS3CODEFACTORY::CORE::Packet packet_type = VS3CODEFACTORY::CORE::Packet_NONE,
...
inline bool VerifyPacket(::flatbuffers::Verifier &verifier, const void *obj, Packet type) {
  switch (type) {
    ...
    case Packet_C2S_CONNECT_REQ: {
      auto ptr = reinterpret_cast<const VS3CODEFACTORY::CORE::C2S_CONNECT_REQ *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Packet_S2C_CONNECT_RES: {
      auto ptr = reinterpret_cast<const VS3CODEFACTORY::CORE::S2C_CONNECT_RES *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Packet_C2S_ENTER_REQ: {
      auto ptr = reinterpret_cast<const VS3CODEFACTORY::CORE::C2S_ENTER_REQ *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Packet_S2C_ENTER_RES: {
      auto ptr = reinterpret_cast<const VS3CODEFACTORY::CORE::S2C_ENTER_RES *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Packet_C2S_USERLIST_REQ: {
      auto ptr = reinterpret_cast<const VS3CODEFACTORY::CORE::C2S_USERLIST_REQ *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Packet_S2C_USERLIST_RES: {
      auto ptr = reinterpret_cast<const VS3CODEFACTORY::CORE::S2C_USERLIST_RES *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Packet_C2S_LEAVE_REQ: {
      auto ptr = reinterpret_cast<const VS3CODEFACTORY::CORE::C2S_LEAVE_REQ *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Packet_S2C_LEAVE_RES: {
      auto ptr = reinterpret_cast<const VS3CODEFACTORY::CORE::S2C_LEAVE_RES *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Packet_C2S_CHAT_REQ: {
      auto ptr = reinterpret_cast<const VS3CODEFACTORY::CORE::C2S_CHAT_REQ *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Packet_S2C_CHAT_RES: {
      auto ptr = reinterpret_cast<const VS3CODEFACTORY::CORE::S2C_CHAT_RES *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Packet_S2C_DISCONECTED_RES: {
      auto ptr = reinterpret_cast<const VS3CODEFACTORY::CORE::S2C_DISCONECTED_RES *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline const VS3CODEFACTORY::CORE::Root *GetRoot(const void *buf) {
  return ::flatbuffers::GetRoot<VS3CODEFACTORY::CORE::Root>(buf);
}

inline const VS3CODEFACTORY::CORE::Root *GetSizePrefixedRoot(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<VS3CODEFACTORY::CORE::Root>(buf);
}

inline bool VerifyRootBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<VS3CODEFACTORY::CORE::Root>(nullptr);
}

inline bool VerifySizePrefixedRootBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<VS3CODEFACTORY::CORE::Root>(nullptr);
}

inline void FinishRootBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<VS3CODEFACTORY::CORE::Root> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_PROTOCOL_VS3CODEFACTORY_CORE_H_
